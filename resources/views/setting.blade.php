...
<div id="app">
    ...
    <div v-on:click="openFavorite" class="setting__btn"><i class="far fa-heart"></i>お気に入りレシピ</div>
    ...
    <div v-on:click="openUser" class="setting__btn"><i class="far fa-heart"></i>ユーザー情報の変更</div>
    ...
    <form class="user__clear" action="{{ route('clear') }}" method="POST">
        @csrf
        <button class="setting__clearBtn" type="submit"><i class="fas fa-trash-alt"></i>全ての食材データを削除する</button>
    </form>
    ...
    <div class="setting__btn-danger"><i class="fas fa-sign-out-alt"></i>ログアウト</div>
    </a>
