...
<div id="app" class="container-md">
    <h1 class="py-4 text-center">マイ食材</h1>

    <div class="my-material__box-container px-5">
        <a href="{{ route('update-materials') }}">
            <div class="my-material__box p-4">
                <div class="my-material__box-top d-flex justify-content-between">
                    ...
                    <span class="arrow circle mr-3"></span>
                </div>
    ...
    @if($count > 0)
    <form class="user__clear mt-0" action="{{ route('clear') }}" id="deleteForm" method="POST">
        @csrf
