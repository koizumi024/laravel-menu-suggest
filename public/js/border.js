...
function selectMaterial14(){
    let element = document.getElementById(14);
...
function selectMaterial16(){
    let element = document.getElementById(16);
...
function selectMaterial19(){
    let element = document.getElementById(19);
...
function selectMaterial20(){
    let element = document.getElementById(20);
...
function selectMaterial22(){
    let element = document.getElementById(22);
...
function selectMaterial24(){
    let element = document.getElementById(24);
...
function selectMaterial27(){
    let element = document.getElementById(27);
...
function selectMaterial28(){
    let element = document.getElementById(28);
...
function selectMaterial29(){
    let element = document.getElementById(29);
